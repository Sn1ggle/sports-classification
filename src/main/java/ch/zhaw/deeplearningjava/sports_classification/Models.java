...
/**
 * Hilfsklasse für Modell-Initialisierung und Speichern der synset.txt
 */
public final class Models {

    public static final int NUM_OF_OUTPUT = 20; // 20 Sportarten
    public static final int IMAGE_HEIGHT = 224;
    public static final int IMAGE_WIDTH = 224;
    public static final String MODEL_NAME = "sportsclassifier";
